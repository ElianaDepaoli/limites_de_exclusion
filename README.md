...
-Sección eficaz total de interacción de gammas con Uranio. Obtenida a partir de tablas de datos nucleares (datos experimentales)
-Flujo gamma modelado para el reactor FRJ-1, válido para E$_{\gamma \geq 200$ keV}. Ecuación (3) de Park, 2017
...
-Longitud de decaimiento de fotones masivos oscuros. Ecuación (5) de Park, 2017
